...
parser.add_argument('--dataset_path',default = '/content/drive/MyDrive/lits/fixed',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/content/drive/MyDrive/lits/rawData/test',help='Testset path')
...
# train
parser.add_argument('--epochs', type=int, default=200, metavar='N',help='number of epochs to train (default: 30)')
